...
async function init() {
    try {
        ...
        alert('Failed to initialize AR. Please check camera permissions.');
    }
}
...
async function loadNutritionData() {
    try {
        ...
        console.log('Nutrition data loaded:', Object.keys(nutritionData).length, 'items');
    } catch (error) {
...
function updateNutritionDisplay() {
    ...
    document.getElementById('portion-value').textContent = currentPortion.toFixed(1) + 'x';
